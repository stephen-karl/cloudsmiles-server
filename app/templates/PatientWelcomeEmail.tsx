...
type PatientWelcomeEmailProps = {
  firstName: string;
  email: string;
  password: string;
}

const PatientWelcomeEmail = ({ firstName, email, password }: PatientWelcomeEmailProps) => {
  return (
    <Html>
      <Head>
        <Font
      ...
      <Tailwind>
        <Container className="max-w-3xl mx-auto p-6 bg-white ">
          ...
          <Text className="text-base text-gray-700 mb-6">
            Welcome to VS Dental! We're thrilled to have you as a patient. As part of your onboarding process, we've created an account for you in our system. Below, you'll find your login details to access your patient portal:
          </Text>
          ...
          <Text className="text-base text-gray-700 mb-6">
            ...
            . Once logged in, you'll be able to schedule appointments, view your dental records, and access other important resources.
          </Text>

          <Text className="mt-4 text-base text-gray-700 text-start">
            If you have any questions or need assistance, feel free to reach out to our support team at <b>support@vsdental.com</b>.
          </Text>
